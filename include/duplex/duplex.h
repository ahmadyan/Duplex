...
protected:
  ...
  // points to optimum solution with lowest score/loss, should be updated in
  // score method
  State *optimum;
...
public:
  ...
  // methods for optimizing the function, most of these methods should also be
  // implemented in the inherited classes too
